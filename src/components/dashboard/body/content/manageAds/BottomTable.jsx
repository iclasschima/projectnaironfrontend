...
{/* <Grid columns='one'>
    <Grid.Column>
    <Header as='h6' id='popup_header'>Format</Header>
    <Form>
        <Form.Field>
        <Checkbox
            radio
...
<Grid.Column>
    <Header as='h6'>Include</Header>
    <Checkbox label='Budget' /> <br />
    <Checkbox label='Reach' /> <br />
    <Checkbox label='Impression' /> <br />
    <Checkbox label='Spent'/>
</Grid.Column>
</Grid> */}